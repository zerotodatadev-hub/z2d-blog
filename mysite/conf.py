...
BLOG_AUTHOR = "Max @ Z2D"  # (translatable)
BLOG_TITLE = "ZERO TO DATA"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://z2d.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "zerotodata.dev@gmail.com"
BLOG_DESCRIPTION = "This is the official blog ZERO TO DATA (Z2D)"  # (translatable)
...
#     ]
# }
DEPLOY_COMMANDS = {"default": ["ghp-import -n -p -f output"]}
...
# before deploying.
GITHUB_COMMIT_SOURCE = False  # keep source commits separate
...
#
CODE_COLOR_SCHEME = None  # "monokai"
